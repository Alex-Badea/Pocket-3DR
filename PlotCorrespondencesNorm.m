function PlotCorrespondencesNorm( im1, im2, K, CorrsNorm, CorrsNormIn, mode )
%PLOTCORRESPONDENCESNORM Summary of this function goes here
%   Detailed explanation goes here
if ~exist('mode','var')
    mode = 'overlay';
end

x1 = Dehomogenize(K*Homogenize(CorrsNorm(1:2,:)));
x2 = Dehomogenize(K*Homogenize(CorrsNorm(3:4,:)));
x1Inliers = Dehomogenize(K*Homogenize(CorrsNormIn(1:2,:)));
x2Inliers = Dehomogenize(K*Homogenize(CorrsNormIn(3:4,:)));
