...
im2 = imread('bst03.jpg');
im3 = imread('bst05.jpg');
...
[CX, CColor] = RectifyAndDenseTriangulate(K, {im1,im2,im3}, ...
    {K'\E1/K,K'\E2/K}, {P1,P2,P3});%, {'plotCorrespondences','plotDisparityMap'});
figure, pcshow(CX{1}')
figure, pcshow(CX{2}')
